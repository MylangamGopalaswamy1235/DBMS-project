...
module.exports = async (req, res) => {
  ...
  // Demo mode: no database configured — acknowledge submission without persisting
  if (!process.env.DATABASE_URL) {
    return res.status(201).json({ message: 'Feedback submitted successfully! (Demo mode — connect a database to persist data)' });
  }

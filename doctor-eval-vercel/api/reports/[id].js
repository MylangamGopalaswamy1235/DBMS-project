...
module.exports = async (req, res) => {
  ...
  if (!process.env.DATABASE_URL) {
    ...
    return res.json({
      doctor,
      feedbacks: [
        { id: 1, rating: 4, comments: 'Good experience overall.', treatment_result: 'Improved', created_at: new Date().toISOString(), patient_name: 'Demo User' },
      ],
      stats: { total_feedback: 1, average_rating: 4.0 },
      demo: true
    });
  }
